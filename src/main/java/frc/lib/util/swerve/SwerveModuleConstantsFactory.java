...
public class SwerveModuleConstantsFactory {
  ...
  public frc.lib.util.swerve.SwerveModule.ClosedLoopOutputType SteerMotorClosedLoopOutput =
      frc.lib.util.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
  /** The closed-loop output type to use for the drive motors. */
  public frc.lib.util.swerve.SwerveModule.ClosedLoopOutputType DriveMotorClosedLoopOutput =
      frc.lib.util.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
   ...
   */
  public frc.lib.util.swerve.SwerveModuleConstants.SteerFeedbackType FeedbackSource =
      frc.lib.util.swerve.SwerveModuleConstants.SteerFeedbackType.RemoteCANcoder;
  ...
  public SwerveModuleConstantsFactory withSteerMotorClosedLoopOutput(
      frc.lib.util.swerve.SwerveModule.ClosedLoopOutputType outputType) {
  ...
  public SwerveModuleConstantsFactory withFeedbackSource(
      frc.lib.util.swerve.SwerveModuleConstants.SteerFeedbackType source) {
   ...
   */
  public frc.lib.util.swerve.SwerveModuleConstants createModuleConstants(
      int steerId,
      int driveId,
      int cancoderId,
    ...
    return new frc.lib.util.swerve.SwerveModuleConstants()
