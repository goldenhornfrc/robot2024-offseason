...
import frc.lib.util.swerve.SwerveDrivetrainConstants;
import frc.lib.util.swerve.SwerveModule.ClosedLoopOutputType;
import frc.lib.util.swerve.SwerveModuleConstants;
import frc.lib.util.swerve.SwerveModuleConstants.SteerFeedbackType;
import frc.lib.util.swerve.SwerveModuleConstantsFactory;
...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains =
      new Slot0Configs().withKP(80).withKI(0).withKD(0.2).withKS(0).withKV(1.5).withKA(0);
