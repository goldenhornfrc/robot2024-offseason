...
public class SwerveModuleConstantsFactory {
  ...
  public frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType SteerMotorClosedLoopOutput =
      frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
  /** The closed-loop output type to use for the drive motors. */
  public frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType DriveMotorClosedLoopOutput =
      frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
   ...
   */
  public frc.robot.util.swerve.SwerveModuleConstants.SteerFeedbackType FeedbackSource =
      frc.robot.util.swerve.SwerveModuleConstants.SteerFeedbackType.RemoteCANcoder;
