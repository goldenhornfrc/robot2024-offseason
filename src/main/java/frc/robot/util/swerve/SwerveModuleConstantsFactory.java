...
public class SwerveModuleConstantsFactory {
    ...
    public frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType SteerMotorClosedLoopOutput = frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
    /** The closed-loop output type to use for the drive motors. */
    public frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType DriveMotorClosedLoopOutput = frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType.Voltage;
     ...
     * data.
     */
    public frc.robot.util.swerve.SwerveModuleConstants.SteerFeedbackType FeedbackSource = frc.robot.util.swerve.SwerveModuleConstants.SteerFeedbackType.RemoteCANcoder;
    ...
    public SwerveModuleConstantsFactory withSteerMotorClosedLoopOutput(
           frc.robot.util.swerve.SwerveModule.ClosedLoopOutputType outputType) {
    ...
    public SwerveModuleConstantsFactory withFeedbackSource(
           frc.robot.util.swerve.SwerveModuleConstants.SteerFeedbackType source) {
     ...
     */
    public frc.robot.util.swerve.SwerveModuleConstants createModuleConstants(
            int steerId,
            int driveId,
            int cancoderId,
        ...
        return new frc.robot.util.swerve.SwerveModuleConstants()
