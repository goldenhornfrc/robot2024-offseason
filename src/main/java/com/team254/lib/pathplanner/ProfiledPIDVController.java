...
public class ProfiledPIDVController implements Sendable {
  ...
  public double calculate(double measurement, double measurementVelocity) {
    ...
    return m_controller.calculate(
        measurement, measurementVelocity, m_setpoint.position, m_setpoint.velocity);
  }
  ...
  public double calculate(
      double measurement, double measurementVelocity, TrapezoidProfile.State goal) {
    setGoal(goal);
